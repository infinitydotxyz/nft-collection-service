...
//   private readonly isMonitoringErrors = false;
...
//   //   const considerInvalidAfter = 1 * ONE_HOUR;
//   //   const updatedAt = collection?.state?.create?.updatedAt;
//   //   const hasHadTimeToMakeProgress = typeof updatedAt === 'number' && updatedAt + considerInvalidAfter < Date.now();
...
//     //   // collection complete
//     // }  else if (!hasMadeProgress || errored) {
//     //   // collection failed to be created
//     //   logger.log(`Failed to create collection: ${chainId}:${address}`);
//     // } else if (isQueued) {
