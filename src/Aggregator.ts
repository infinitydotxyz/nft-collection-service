...
export default class Aggregator {
    ...
    async getInitalData(): Promise<any> {
        try{
            ...
            const mintsStream = await this.contract.getMints({fromBlock: blockDeployedAt, toBlock: "latest", returnType: "stream"}) as Readable;
            ...
            const results = tokenMetadataPromiseResults.reduce(( acc: {failed: unknown[], successful: unknown[]}, item ) => {
